    ...
    return (
        <View >
            ...
            <View style={{ marginTop: 10 }}>
                <Text style={Styles.optionTitle}>Closet Size</Text>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={Styles.flex}>
                    <Text style={Styles.title}>Small Closet</Text>
                    {/* <Checkbox color={'#2196F3'} uncheckedColor={'#2196F3'} status={checked ? 'checked' : 'unchecked'} onPress={() => {setChecked(!checked); }}/> */}
                </View>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={Styles.flex}>
                    <Text style={Styles.title}>Medium Closet</Text>
                    {/* <Checkbox color={'#2196F3'} uncheckedColor={'#2196F3'} status={checked ? 'checked' : 'unchecked'} onPress={() => {setChecked(!checked); }}/> */}
                </View>
                <View style={[Styles.setPadding, { marginTop: 2 }]}>
                    <View style={Styles.inputLabel}>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={Styles.flex}>
                    <Text style={Styles.title}>Large Closet</Text>
                    {/* <Checkbox color={'#2196F3'} uncheckedColor={'#2196F3'} status={checked ? 'checked' : 'unchecked'} onPress={() => {setChecked(!checked); }}/> */}
                </View>
                <View style={[Styles.setPadding, { marginTop: 2 }]}>
                    <View style={Styles.inputLabel}>
